            ...
            <form action="{{ route('checkout.process') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div id="epayment-info-section" class="hidden mt-4 p-4 border border-blue-200 rounded-lg bg-blue-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="text-sm text-gray-700 mb-1"><strong>Atau Transfer ke Nomor Rekening:</strong></p>
                            <p class="text-md font-semibold text-gray-800">Bank XYZ: <span class="text-indigo-600">123-456-7890</span></p>
                            <p class="text-sm text-gray-600">Atas Nama: <span class="font-medium">Toko Pakaian Anda</span></p>
                ...
                <div id="admin-verifier-section" class="hidden"> {{-- Awalnya disembunyikan, muncul jika metode 'cash' dipilih --}}
                    <label for="verified_by_admin_id" class="block text-sm font-medium text-gray-700 mb-1">Pilih Admin (untuk Pembayaran Tunai)</label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function toggleAdminVerifier() {
        if (paymentMethodSelect.value === 'cash') {
            ...
            adminVerifierSection.classList.add('hidden');
